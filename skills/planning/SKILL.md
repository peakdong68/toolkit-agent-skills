...
**[Template: `plan-template.md`]** — the co-located template file in this skill's directory is the authoritative plan structure. Load it when producing the plan document. The required sections are summarized below; the template provides the full markup.
...
| Large implementation (3+ independent tasks) | `subagent-driven-development` | Parallel execution with review gates |
