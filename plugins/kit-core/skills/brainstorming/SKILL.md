...
3. 审查 `docs/changes/<date>_<topic>/design.md` 中的现有设计，了解相关的先前工作
4. 从现有架构中识别约束条件
...
| 现有代码                                | 当前模式、架构         | 高     |
| 最近提交                                | 开发方向               | 中     |
| `docs/changes/<date>_<topic>/design.md` | 过往设计与决策         | 中     |
...
1. 将已验证的设计写入 `docs/changes/<date>_<topic>/design.md`
2. 提交设计文档
3. 更新自学习记忆：
...
```
设计已获批准并保存至 docs/changes/2026-05-15_01_dark-mode/design.md。
